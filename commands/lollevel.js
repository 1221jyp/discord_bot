...
module.exports = {
	data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option
                .setName('id')
                .setDescription('your lol id here!')
                .setRequired(true)
                ),
	async execute(interaction) {
        const username = interaction.options.getString('id');
        const url = `https://kr.api.riotgames.com/lol/summoner/v4/summoners/by-name/${urlencode(username)}?api_key=${process.env.riottoken}`
